...
- [ ] T204 Разбирать дробные числа ISS сразу в Decimal без промежуточного float.
- [ ] T205 Сохранять частичные глобальные ряды и ЦБ, передавая ошибки и незавершённость.
- [ ] T206 Различить сбой и отсутствие истории фьючерса; использовать полученные при поиске снимки.
- [ ] T207 Сохранять позиции при ошибке/остановке и учитывать семейство в ключе повторного сбора.
- [ ] T208 Ввести единое доказуемое правило полноты, включая диапазоны и старые исходы.
- [ ] T209 Применить его к сводке, догону, готовности, объявлению полноты набора и устареванию.
- [ ] T210 Ограничить план выбранными группами и собственными окнами источников.
- [ ] T211 Уменьшить лишние HTTP/SQL-запросы и подтвердить результат сопоставимыми измерениями.
- [ ] T212 Выполнить управляемый аудит и адресное восстановление накопленных пропусков.
- [ ] T213 Подтвердить исправления регрессиями, полным scripts/check.sh и живыми сверками.
- [ ] T214 Актуализировать документацию и записать доказательства итоговой готовности.
