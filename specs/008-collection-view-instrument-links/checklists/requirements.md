...
- Восемь пунктов разбора 2026-09-17 закрыты требованиями FR-020a–FR-020d и
  FR-031–FR-041; критерии SC-009 и SC-010 проверяют исходную проблему и своевременность
  ежедневного сбора.
- Сценарии US3.2, US3.3 и US3.4 переписаны: они больше не обещают того, что данные не
  позволяют утверждать.
- Спецификация готова к `/speckit-plan`. Расхождения макета v4 остаются отдельной
  работой и планированию не мешают.
