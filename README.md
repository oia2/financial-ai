...
Недостающей считается любая закрытая сессия окна без собранных котировок — и отставание
границы, и пропуск **внутри** окна. Прежде искалось только первое, и дыра посреди истории
