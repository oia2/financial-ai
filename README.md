...
Разрыв данных догоняется автоматически на всю глубину окна догона. Если предел задан
числом в `MARKET_DATA_STARTUP_RECOVERY_MAX_SESSIONS`, разрыв сверх него не собирается
вовсе, показывается человеку и чинится управляемым догоном.
