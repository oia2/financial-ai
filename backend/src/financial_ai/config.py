...
class Settings(BaseSettings):
    ...
    market_data_ingest_after_close: str = Field(
        # Итог торгового дня (утро, основная и вечерняя сессии) ISS публикует
        # около 23:59 МСК: раньше данных за день нет, а вечерняя сессия идёт
        # до 23:50 (spec 008, FR-040c). Прежние 19:30 обещали сбор за четыре
        # часа до публикации.
        default="23:59",
        description=(
